...
import { fetchProducts, getSaleProducts, getProductbyCategory } from '../../../src/services/api/productService';
        ...
        <div className={styles.wrapper}>
            ...
            <div className={styles.swiper}>
                {products.map((product) => (
                    <div key={product._id} className={styles.item} onClick={() => handleProductClick(product._id)}>
                        <div className={styles.ItemImg}><img className={styles.picture} src={product.product_details.product_images[0].secure_url} alt={product.product_name} /></div>
                        <div>
                            <span className={styles.desc}>{product.product_short_description}</span>
                            <div className={styles.footerItem}>
                                <div>
