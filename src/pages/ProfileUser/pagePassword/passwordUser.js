...
//   const [email, setEmail] = useState(''); // Thay đổi email bằng cách thích hợp
...
//         <span className={styles.changePassword} style={{ fontSize: '24px', fontWeight: '300' }}>
//           ĐỔI MẬT KHẨU
//         </span>
//         {errorMessage && <p style={{ color: 'red' }}>{errorMessage}</p>}
//         <form method="post" action="/users/change-password/{{email}}?_method=PUT" onSubmit={handleSubmit}>
//           <span style={{ fontSize: '14px', fontWeight: '400', color: '#0a0000' }}>
//             <strong>Lưu ý:</strong> Để đảm bảo tính bảo mật bạn vui lòng đặt lại mật khẩu với ít nhất 8 kí tự
//           </span>
  ...
  return (
    <div className={styles.profile}>
      <div className={styles.profileUser}>
        ...
        {errorMessage && <p style={{ color: 'red' }}>{errorMessage}</p>}
        <form method="post" action={`/account/changepassword/?_method=PUT`} onSubmit={handleSubmit}>
          <span style={{ fontSize: '14px', fontWeight: '400', color: '#0a0000' }}>
            <strong>Lưu ý:</strong> Để đảm bảo tính bảo mật bạn vui lòng đặt lại mật khẩu với ít nhất 8 kí tự
          </span>
          <div style={{ marginBottom: '15px' }}>
